...
# If day-to-day difference is over preset limits, throw an error to stop the automatic update. This notifies the maintainers, who can then ensure such large jumps are inspected manually before they are pushed to the live page.
...
generate_model_loop(
  ...
  main_estimate_learning_rate = 0.0003,
...
unlink("output-data/country_daily_excess_deaths_with_covariates_cache.RDS")
