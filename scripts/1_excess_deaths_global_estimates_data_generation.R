...
if(!identical(sort(unique(daily_excess_deaths$iso3c)), sort(c('ALB', 'AUS', 'AUT', 'BEL', 'BGR', 'BIH', 'BLR', 'BOL', 'BRA', 'CAN', 'CHE', 'CHL', 'COL', 'CRI', 'CUB', 'CYP', 'CZE', 'DEU', 'DNK', 'ECU', 'EGY', 'ESP', 'EST', 'FIN', 'FRA', 'GBR', 'GEO', 'GRC', 'GTM', 'HRV', 'HUN', 'IRL', 'IRN', 'ISL', 'ISR', 'ITA', 'JAM', 'JPN', 'KAZ', 'KGZ', 'KOR', 'LBN', 'LTU', 'LUX', 'LVA', 'MDA', 'MEX', 'MKD', 'MLT', 'MNE', 'MNG', 'MUS', 'MYS', 'NIC', 'NLD', 'NOR', 'NZL', 'OMN', 'PAN', 'PER', 'PHL', 'POL', 'PRT', 'PRY', 'QAT', 'ROU', 'RUS', 'SGP', 'SLV', 'SRB', 'SVK', 'SVN', 'SWE', 'THA', 'TJK', 'TUN', 'TWN', 'UKR', 'URY', 'USA', 'UZB', 'ZAF', "AND", "ARG", "ATG", "HKG", "LIE", "MCO", "SMR", "SYC", "ABW", "BMU", "FRO", "GIB", "GRL", "MAC", "PYF")))){
